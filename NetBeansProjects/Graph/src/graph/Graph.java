...
public class Graph {
    ...
    public void dijkStra(int index ){
        ...
        // CO son las coordenadas necesarias para la iteración, 
        //headIndex es el vértice inicial de cada DIJKSTRA
        ...
        // 1. Establece este vértice en conocido, no te preocupes por la 
            aadistancia y la ruta de este punto, porque ha sido diseñado antes
        // 2. Encuentra cada vértice adyacente de este vértice. Para un vértice 
            desconocido, compare la distancia alcanzada a lo largo de este vértice 
            con su distancia original, si es menor que la distancia original, 
            actualice la distancia y actualice la ruta
        // 3. Después de establecer este vértice, use la función indexGet para 
            encontrar el vértice con la distancia más pequeña entre los vértices 
            desconocidos actuales, y utilícelo como el siguiente vértice para   
            realizar el paso 2
        */
        while (!isVisited[headIndex]){
            ...
            // Si el vértice headIndex no tiene vértices adyacentes que no hayan 
            // sido visitados, la coordenada del vértice se obtiene como n, lo 
            // que indica que es el último nodo desconocido, y solo necesita 
            // establecerse como conocido
